...
<body>
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/welcome')}}">首页</a> &raquo; 友情链接列表
    </div>
    <!--面包屑导航 结束-->
                ...
                <table class="list_tab">
                    ...
                    <tr>
                       ...
                       <!--  <td class="tc">
                        ...
                        <!-- <td></td> -->
                        <td>
                            <a href="{{url('admin/link/edit/id/'.$v->id)}}">修改</a>
...
<script type="text/javascript">
    function del(id){
        layer.confirm('您确定要删除这个友情链接吗？', {
            ...
            $.post("{{url('admin/link/del')}}",{'_token':"{{csrf_token()}}",'id':id},function (data) {
                if(data.status==1){
