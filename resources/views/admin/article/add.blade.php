...
<div class="result_wrap">
    <form action="{{url('admin/article/docreate')}}" method="post">
        {{csrf_field()}}
        <table class="add_tab">
            <tbody>
            <tr>
            ...
            <tr>
                <th>作者：</th>
                <td>
                    <input type="text" class="sm" name="auther">
                </td>
            </tr>
            <tr>
                <th>缩略图：</th>
                <td>
                    <input type="text" name="picname" id="thumbnail" value="" size="30" class="inpMain" />
