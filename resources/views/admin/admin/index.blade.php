...
<body>
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/welcome')}}">首页</a> &raquo; 管理员列表
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{url('admin/admin/create')}}"><i class="fa fa-plus"></i>添加管理员</a>
                ...
                <table class="list_tab">
                    ...
                    <tr>
                       ...
                       <!--  <td class="tc">
                        ...
                        <!-- <td></td> -->
                        <td>
                            <a href="{{url('admin/admin/edit/id/'.$v->id)}}">修改密码</a>
...
<script type="text/javascript">
    function del(id){
        layer.confirm('您确定要删除这个管理员吗？', {
            ...
            $.post("{{url('admin/admin/del')}}",{'_token':"{{csrf_token()}}",'id':id},function (data) {
                if(data.status==1){
